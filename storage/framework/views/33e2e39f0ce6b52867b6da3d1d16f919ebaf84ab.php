...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        <div style="display: flex; flex-direction: row; justify-content: space-between; width: 100%; height: 115px; text-align: center">
            <!-- Input data -->
            ...
            <div class="boxcount" style="width: 28%; height:50%; text-align: center;">
                ...
                <b style="font-size: 2.5em"><?php echo e(count($findPage)); ?></b>
            </div>
        </div>
    </div>
                    ...
                    <thead>
                        <tr>
                            <div style="width: auto; text-align: center; font-size: 110%">
                                <strong>Período : <?php echo e($periodocomeco); ?> - <?php echo e($periodofinal); ?></strong>
                            </div>
                        </tr>
                    <tr>
    ...
    <script type="text/javascript">
        ...
        function onChange() {
            ...
            if (data != "" && data_final != "") {
                ...
                var dados = {cpffunc: session('cpffunc')}
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/vendedor.app.gruponobre.com/resources/views/vendas.blade.php ENDPATH**/ ?>