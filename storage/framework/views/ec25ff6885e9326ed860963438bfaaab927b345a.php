                        ...
                        <li class="<?php echo e($subitem['top_nav_class']); ?>">
                            <a href="<?php echo e($subitem['href']); ?>">
                                ...
                                <?php if(isset($subitem['label'])): ?>
                                    <span
                                        class="label label-<?php echo e($subitem['label_color'] ?? 'primary'); ?>"><?php echo e($subitem['label']); ?></span>
                                <?php endif; ?>
                            </a>
                        </li>
                    <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/vendedor.app.gruponobre.com/resources/views/vendor/adminlte/partials/menu-item-top-nav.blade.php ENDPATH**/ ?>