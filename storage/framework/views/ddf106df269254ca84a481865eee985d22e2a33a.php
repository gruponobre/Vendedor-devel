    ...
    <div>
        <div style="width:80%; display: flex; flex-direction:column; text-align: center; margin-left: 10%">
            ...
            <div class="caixamaior" style="width: 45%; height: 50%">
                <div style="width: 100%;">
                    ...
                    <b style="font-size: 7vw"><?php echo e('R$ '. $comissao->comissao); ?></b><br>
                </div>
            </div>
            ...
            <div style="display: flex; flex-direction:row; justify-content: space-between;  margin-top: 10px; width: 100%">
                <div class="caixamenor"  style="width: 40%; height: 95%">
                    <div style="margin: 0 auto">
                        ...
                        <b style="font-size: 6vw"><?php echo e($comissao->clientes); ?></b>
                    </div>
                </div>
                ...
                <div class="caixamenor"  style="width: 40%; height: 95%">
                    <div style="margin: 0 auto">
                        ...
                        <b style="font-size: 6vw"><?php echo e($comissao->pagamentos); ?></b>
                    </div>
                </div>
        ...
        <div style="margin:0 auto; display: flex; flex-direction: row; justify-content: space-between; width: 90%; margin-top: 2%; text-align: center">
            <div class="form-group">
                <form class="form-horizontal" method="get" action="<?php echo e(getenv('APP_URL')); ?>/pagamentos" name="form" id="form" style="width: 80%">
                ...
                <div class="box">
                    ...
                    <div class="box-body no-padding">
                        <table class="table table-striped">
                            <tbody style="font-size: 90%">
                                <tr>
                                    <div style="width: auto; text-align: center; font-size: 110%">
                                        <strong>Período : <?php echo e($comissao->datainit); ?> - <?php echo e($comissao->datafim); ?></strong>
                                    </div> 
                                </tr>
                                <tr>
                                    <th>Cód</th>
                            ...
                            <?php $__currentLoopData = $comissao->lista; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pessoa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/vendedor.develapp.gruponobre.com/resources/views/pagamentos.blade.php ENDPATH**/ ?>