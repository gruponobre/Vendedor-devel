        ...
        >
            ...
            <?php if(isset($item['label'])): ?>
                <span class="pull-right-container">
                    <span
                        class="label label-<?php echo e($item['label_color'] ?? 'primary'); ?> pull-right"><?php echo e($item['label']); ?></span>
                </span>
...
<?php endif; ?>
<?php /**PATH /var/www/html/vendedor.develapp.gruponobre.com/resources/views/vendor/adminlte/partials/menu-item.blade.php ENDPATH**/ ?>