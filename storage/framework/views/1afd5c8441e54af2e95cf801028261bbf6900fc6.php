...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <nav class="navbar navbar-static-top">
            ...
            <!-- Header Navbar -->
            <nav role="navigation" style="background-color: #B6E4F2; display: flex; flex-direction: row; justify-content: space-between; align-items: center; width: 100%; height: 5%;">
            ...
            <!-- Navbar Right Menu -->
                ...
                <p align="center"> 
                    <div style="display: flex; flex-direction: row; align-items: center; width: 55%; height: 100%; justify-content: center;">
                        ...
                        <a href="<?php echo e(route('home')); ?>">
                            <span style=" width: 50%; height: 70%; display: flex; flex-direction: row;align-content: center;">
        ...
        <div style="display: flex; justify-content: center; flex-direction: column; ">
            <div class="pull-left image" style="margin: 0 auto">
                <form runat="server" action="<?php echo e(route('postar')); ?>" method="POST" enctype="multipart/form-data">
                     <?php echo csrf_field(); ?>
                    <input type="file" id="imgInp" name="imgInp" accept="image/*" value="Escolher" style="display: none" onchange="form.submit()">
                </form>
                <label for="imgInp">
                    <div style="position: relative; width: 100%; height: 90%">
                        <div style="width: 100px; height: 100px">
                            <img id="img" name="img" class="profile-user-img img-circle" src="images/<?php echo e(Session::get('codifunc')); ?>.jpg"  onerror="this.src='/images/perfil.png'" style="width: 100px; height:100px; border-radius: 60px; object-fit: fill">
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/vendedor.app.gruponobre.com/resources/views/vendor/adminlte/page.blade.php ENDPATH**/ ?>