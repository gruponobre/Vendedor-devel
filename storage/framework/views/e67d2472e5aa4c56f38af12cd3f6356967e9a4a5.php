...
<div>
    ...
    <div style="margin-bottom:20px; display: flex; flex-direction: row;
        ...
        <select name='banco' class="form-control" style="width: 27%; margin-top: 10%; background-color: #dddddd">
            <option value="sqlsrvDATASCF">Plasa</option>
            <option value="sqlsrvDATA1ETH">Ethernus</option>
            <option value="sqlsrvDATA1MNB">Mis Nobre</option>
        </select>
    </div>
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/vendedor.app.gruponobre.com/resources/views/vendor/adminlte/login.blade.php ENDPATH**/ ?>